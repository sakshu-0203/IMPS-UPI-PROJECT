...
export class NewTransfer {
  ...
  submitTransfer(): void {
    ...
    if (
      ...
      this.fieldErrors['debitAccount'] =
        'Select a valid debit account.';
    }
    ...
    if (
      ...
      this.fieldErrors['beneficiaryName'] =
    ...
    if (
      ...
      this.fieldErrors['beneficiaryAccount'] =
    ...
    if (!validAmount(this.amount)) {
      ...
      this.fieldErrors['amount'] =
        'Amount must be greater than ₹0 and not exceed ₹5,00,000.';
    }
    ...
    if (
      ...
      this.fieldErrors['purpose'] =
        'Select a transfer purpose.';
    }
